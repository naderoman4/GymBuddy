          ...
          <div className="space-y-2">
            {methods.map((m) => (
              <button
                ...
                className="w-full flex items-center gap-3 bg-white border border-gray-200 rounded-xl p-4 hover:border-gray-300 hover:shadow-sm active:bg-gray-50 transition-all text-left"
              >
                <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center shrink-0">
                  <m.icon className="text-blue-600" size={20} />
                </div>
        ...
        <div className="max-w-lg mx-auto flex gap-2">
          {currentStep > 0 && (
            <button
              ...
              className="flex items-center justify-center gap-1 h-10 px-4 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 active:bg-gray-100 transition-colors text-sm font-medium"
            >
              <ChevronLeft size={16} />
              {t('onboarding.back')}
            </button>
          ...
          <button
            onClick={handleNext}
            disabled={saving}
            className="flex-1 flex items-center justify-center gap-1 h-10 bg-blue-600 text-white px-6 rounded-lg hover:bg-blue-700 active:bg-blue-800 disabled:bg-gray-300 transition-colors text-sm font-medium"
          >
            {saving
              ? t('profile.saving')
              : currentStep === TOTAL_STEPS - 1
                ...
                : t('onboarding.next')}
            {!saving && currentStep < TOTAL_STEPS - 1 && <ChevronRight size={16} />}
          </button>
        </div>
      </div>
    </div>
